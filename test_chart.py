...
if uploaded_file is not None:
    try:
        data = pd.read_csv(uploaded_file, encoding='ISO-8859-1', delimiter='auto') if uploaded_file.name.endswith('csv') else pd.read_excel(uploaded_file, encoding='ISO-8859-1')
